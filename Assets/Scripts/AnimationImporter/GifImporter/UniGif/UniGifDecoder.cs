...
public static partial class UniGif
{
    ...
    /// </summary>
    public static ushort GetDisposalMethod(GraphicControlExtension? graphicCtrlEx)
    {
    ...
    /// </summary>
    public static Texture2D CreateTexture2D(GifData gifData, List<GifTexture> gifTexList, int imgIndex, List<ushort> disposalMethodList, Color32 bgColor, FilterMode filterMode, TextureWrapMode wrapMode, out bool filledTexture)
    {
        filledTexture = false;
    ...
    /// </summary>
    public static void SetTexturePixelRow(Texture2D tex, int y, ImageBlock imgBlock, byte[] decodedData, ref int dataIndex, List<byte[]> colorTable, Color32 bgColor, int transparentIndex, bool filledTexture)
    {
        // Row no (0~)
